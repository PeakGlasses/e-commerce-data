...
describe("UserService", () => {
    describe("registerUser", () => {
        ...
        it("should handle registration errors and log them", async () => {
            (userRepository.findUserByEmail as jest.Mock).mockRejectedValue(
            ...
            expect(logger.error).toHaveBeenCalledWith(
                "Registration error: Database error"
            );
        });
    });
    ...
    describe("loginUser", () => {
        ...
        it("should throw an error for incorrect password", async () => {
            ...
            await expect(
                userService.loginUser("john@example.com", "wrong_password")
            ).rejects.toThrow("Invalid email or password");
    ...
    describe("getUserById", () => {
        ...
        it("should handle getUserById errors and log them", async () => {
            (userRepository.findUserById as jest.Mock).mockRejectedValue(
                new Error("Database error")
            );
            ...
            expect(logger.error).toHaveBeenCalledWith(
                "Get user details error: Database error"
            );
        });
    });
});
